...
while True:
    ...
    if A_recieve_flag < 100:
        A_recieve_flag += 1
    else:
        print("A_recieve_flag", A_recieve_flag)
    ...
    if data == 'B' and rect_points_flag == 0:
        still_send_flag = 1
        LED(3).on()
    elif data == 'A' and rect_points_flag == 0 and A_recieve_flag == 100:
        rect_point_num += 1
        data = 'B'
        A_recieve_flag = 0
    ...
    if still_send_flag == 1:
        ...
        if rect_points is not None and red_blobs is not None:
            if rect_point_num < len(rect_points_transform):
                red_send_data = '#0' + 'x' + str(float(red_blob.cx())) + 'y' + str(float(red_blob.cy())) + ';'
                print(red_send_data)
                print('3333333333333333333333333333333333333333333333')
                uart.write(red_send_data)
            else:
                rect_point_num = 0
    ...
    if rect_points_transform is not None and still_send_flag == 0:
